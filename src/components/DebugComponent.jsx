        ...
        <>
          ...
          <ul style={{ listStyleType: 'none', padding: 0 }}>
            <li style={{ 
              padding: '8px', 
              margin: '4px 0', 
              backgroundColor: debug.apiStatus.includes('Success') ? '#e6ffec' : '#ffebe6',
              borderRadius: '4px'
            }}>
            ...
            <li style={{ 
              padding: '8px', 
              margin: '4px 0', 
              backgroundColor: debug.serverStatus.includes('Success') ? '#e6ffec' : '#ffebe6',
              borderRadius: '4px'
            }}>
            ...
            <li style={{ 
              padding: '8px', 
              margin: '4px 0', 
              backgroundColor: debug.adsStatus.includes('Success') ? '#e6ffec' : '#ffebe6',
              borderRadius: '4px'
            }}>
            ...
            <li style={{ 
              padding: '8px', 
              margin: '4px 0', 
              backgroundColor: debug.tokenStatus.includes('Success') ? '#e6ffec' : '#ffebe6',
              borderRadius: '4px'
            }}>
          ...
          <p style={{ fontSize: '12px', color: '#666', marginTop: '15px' }}>
            Environment: {import.meta.env.MODE} | Last updated: {new Date().toLocaleTimeString()}
          </p>
        </>
      )}
    </div>
