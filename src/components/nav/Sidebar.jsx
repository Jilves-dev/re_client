  ...
  return (
    <div className="bg-[#FBE9D0] w-full px-2 py-2 pb-4">
      ...
      <div className="hidden md:flex justify-start gap-6 border-b border-[#874F41] font-poiretOne text-lg">
        ...
        <NavLink
          className="nav-link text-[#244855] !important inline-flex items-center"
      ...
      {/* Mobile toggle — GiSettingsKnobs + badge */}
      <div className="md:hidden z-20 flex items-center bg-[#FBE9D0] border-b border-[#874F41]">
        {!nav ? (
          <>
            {/* Kääri ikonin ympärille relative-div jotta badge asemoituu oikein */}
            <div className="relative mr-2 cursor-pointer" onClick={handleClick}>
              <GiSettingsKnobs
                style={{
                  width: '2.5rem',
                  height: '2.5rem',
                  ...
                  transition:
                    rotation === 0
                      ? 'none'
                      : 'transform 0.6s ease, color 0.3s ease',
                }}
              />
              {/* Badge ikonin oikeaan yläkulmaan */}
              {unreadCount > 0 && (
                <span
            ...
            <span
              onClick={handleClick}
              className="cursor-pointer font-poiretOne text-lg text-[#874F41] mb-2"
            >
              DashboardNavigatioN
            </span>
          </>
          ...
          <>
            ...
            <span
              onClick={handleClick}
              className="cursor-pointer font-poiretOne text-lg text-[#E64833] mb-2 hover:text-[#874F41] transition-colors"
            >
              closeMenu
            </span>
          </>
      ...
      {nav && (
        <div
          className="fixed top-0 right-0 w-[65%] max-w-md h-screen bg-[rgba(253,235,211,0.8)]
          ...
          >
            ...
            <li className="py-4 text-4xl">
              <a
                ...
                onClick={(e) => handleNavLinkClick(e, '/user/conversations')}
              >
                Messages
                <UnreadBadge />
              </a>
