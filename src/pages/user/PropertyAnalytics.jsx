        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-8">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            ...
            <div className="w-full sm:w-48 h-48 flex-shrink-0">
              <img
                src={
                  ad.photos?.[0]?.Location || 'https://via.placeholder.com/200'
                }
                alt={ad.address}
                className="w-full h-full object-cover rounded-lg"
              />
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 text-sm text-gray-600 mb-4">
                ...
                <div>
                  <span className="text-gray-500">Status:</span>{' '}
                  <span
                    className={`font-semibold ${ad.sold ? 'text-red-600' : 'text-green-600'}`}
                  >
                    {ad.sold ? 'Sold' : 'Active'}
                  </span>
                </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-[#244855] font-medium">
                      {activity.userName || 'Anonymous'} {activity.type}ed this
                      property
                    </p>
