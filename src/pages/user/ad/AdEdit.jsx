...
export default function AdEdit() {
  ...
  // ✅ KÄYTÄ IMAGEUPLOAD KOMPONENTIN CALLBACKIA
  /*const handleImageUpload = (photos) => {
    setAd({ ...ad, photos });
  };*/
  ...
  /*const handleImageRemove = async (imageToRemove) => {
    try {
      ...
      // ✅ Käytä olemassa olevaa remove-image endpointtia
      await axios.post("/remove-image", imageToRemove);

      // Poista statesta
      const updatedPhotos = ad.photos.filter(
        (photo) => photo.Key !== imageToRemove.Key
      );
      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {ad.photos.map((photo, index) => (
                    <div key={photo.Key || index} className="relative group">
                      <img
                        src={photo.Location}
                        alt="Property"
                      ...
                      <button
                        ...
                        disabled={uploading}
                        className="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white w-8 h-8 rounded-full opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center disabled:opacity-50"
                        title="Remove image"
                      >
                        ✕
                      </button>
            ...
            {/* Upload new photos using ImageUpload component 
            <ImageUpload 
              photos={ad.photos} 
              setPhotos={handleImageUpload}
              uploading={uploading}
