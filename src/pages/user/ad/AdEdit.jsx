...
export default function AdEdit() {
  ...
  const handleDelete = async () => {
    if (
      !window.confirm(
        `Are you sure you want to delete "${ad.address}"? This action cannot be undone.`
      )
    ) {
      return;
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#90AEAD] focus:border-transparent bg-white"
                >
            ...
            <p className="text-sm text-gray-500 mt-4">
              💡 Note: Changing estate type will not automatically clear
              house/land specific fields, you must also click update button
              below⬇️
            </p>
          </div>
