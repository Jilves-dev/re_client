    ...
    <div name='home' className='w-full pb-10'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-20">
        ...
        <div className="flex flex-col items-center">
          <button
            onClick={handleSell}
            className="py-2.5 px-10 me-2 mb-2 text-sm font-medium font-castoro
          ...
          >
            <span className="h2 font-castoro">Sell</span>
          </button>
          {sell && (
            <div className="flex justify-center gap-4">
              <button
                onClick={() => navigate("/ad/create/sell/House")}
                className="py-2.5 px-5 me-2 mb-2 text-sm font-medium font-castoro
                !text-[#E64833] focus:outline-none !bg-[#FBE9D0] 
                rounded border-2 !border-[#874F41] !hover:bg-[#90AEAD]
                !hover:text-[#FFFFFF] focus:z-10 focus:ring-4
                focus:ring-gray-100 dark:focus:ring-gray-700
              ...
              <button
                ...
                className="py-2.5 px-5 me-2 mb-2 text-sm font-castoro font-medium
                !text-[#E64833] focus:outline-none !bg-[#FBE9D0] 
                rounded border-2 !border-[#874F41] !hover:bg-[#90AEAD]
                !hover:text-[#FFFFFF] focus:z-10 focus:ring-4
                focus:ring-gray-100 dark:focus:ring-gray-700
        ...
        <div className="flex flex-col items-center">
          <button
            onClick={handleRent}
            className="py-2.5 px-10 me-2 mb-2 text-sm font-castoro font-medium
            !text-[#E64833] focus:outline-none !bg-[#FBE9D0] 
            rounded border-2 !border-[#874F41] !hover:bg-[#90AEAD]
            !hover:text-[#FFFFFF] focus:z-10 focus:ring-4
            focus:ring-gray-100 dark:focus:ring-gray-700
            ...
            dark:hover:bg-gray-700"
          >
            <span className="h2 font-castoro !font-[#90AEAD]">Rent</span>
          </button>
          {rent && (
            <div className="flex justify-center gap-4">
              <button
                ...
                className="py-2.5 px-5 me-2 mb-2 text-sm font-medium font-castoro
                !text-[#E64833] font-castoro focus:outline-none !bg-[#FBE9D0] 
                rounded border-2 !border-[#874F41] !hover:bg-[#90AEAD]
                !hover:text-[#FFFFFF]  focus:z-10 focus:ring-4
                focus:ring-gray-100 dark:focus:ring-gray-700
                dark:bg-gray-800 dark:text-gray-400
