...
import Logo from '../assets/houseLogo.jpg';
...
export default function Agent() {
  ...
  const customShadow = {
    boxShadow:
      '0 10px 25px -5px rgba(144, 174, 173, 0.5), 0 8px 10px -6px rgba(144, 174, 173, 0.3)',
  };
      ...
      <div className="bg-[#FBE9D0] py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {agent?.about && (
              <div className="mb-6">
                <h3 className="font-poiretOne text-xl text-[#874F41] mb-2">
                  About me
                </h3>
            ...
            {agent?.company && (
              <div className="mb-6">
                ...
                <p className="font-baskervville text-[#244855] text-lg text-justify">
                  {agent.company}
                </p>
              </div>
            )}
            ...
            {agent?.address && (
              <div className="mb-6">
                ...
                <p className="font-baskervville text-[#244855] text-lg">
                  {agent.address}
                </p>
              </div>
            )}
