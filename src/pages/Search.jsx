      ...
      <div name="search">
        {/*</div><div className="row">
          ...
          <>
            <div className="row">
              {search.results?.length > 0 ? (
                <div className="col-md-12 text-center font-decomang text-[#244855] text-2xl p-5">
                  found {search.results?.length} results
                </div>
              ) : (
                <div className="col-md-12 text-center font-decomang text-[#244855] text-2xl p-5">no properties found</div>
              )}
            </div>
